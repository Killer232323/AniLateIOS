...
(async function(namespace) {
    ...
    namespace.FetchDetails = async (id = 19348) => {
        try {
            const result = await fetchFromDetails(id);
            ...
            return result; // Возвращаем результат, если ошибок нет
        } catch (error) {
            console.error('Ошибка при получении данных:', error.message);
            // Возвращаем ошибку или обрабатываем её другим способом
